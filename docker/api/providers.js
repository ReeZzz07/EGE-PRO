...
// Крупные модели (qwen3.8-max, vision) отвечают за 15–30 с, а на длинных разборах приближаются к 45 — при таком
// лимите ответ обрывался бы ошибкой в самый неподходящий момент, поэтому потолок 75 с.
